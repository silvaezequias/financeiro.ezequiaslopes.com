    ...
    <main className="min-h-screen bg-black text-neutral-200">
      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 pt-32 pb-32">
        <div className="text-center">
          ...
          >
            Ops! Carteira inexistente
          </h1>
          <p className="mt-6 text-lg text-neutral-400 max-w-prose mx-auto">
            A carteira que você está procurando não existe, foi removida ou você
            não tem permissão para acessá-la. Verifique se o ID da carteira está
            correto.
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
            ...
            <div className="rounded-lg border border-neutral-900 bg-neutral-950/40 p-4">
              <h3 className="text-neutral-100 font-medium">Dashboard</h3>
              <p className="mt-1 text-sm text-neutral-500">
