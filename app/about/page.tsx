        ...
        <div className="grid gap-10 items-center justify-center">
          <div>
            ...
            >
              ...
              financeira. Com uma interface intuitiva, você pode registrar suas
              transações, acompanhar seu progresso e fazer projeções futuras,
              ajudando você a tomar decisões mais inteligentes.
              <br />
              <br />
              Valorizamos a confiança e a segurança dos nossos usuários. Por
              isso, nossos sistemas são projetados com os mais altos padrões de
              proteção de dados (Seguindo a{" "}
              <a
              ...
              uma visão ainda mais completa das suas finanças, integrando todas
              as suas contas bancárias em um só lugar.
              <br />
              <br /> No momento, nosso foco principal é ajudar você a economizar
              e a manter suas finanças em dia, mas nosso compromisso é crescer
              junto com você, sempre trazendo novas funcionalidades que
              facilitem ainda mais a sua vida.
            </p>
          </div>
        </div>
      </section>
